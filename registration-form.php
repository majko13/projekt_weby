    ...
    <main>
        <section class="registration-form">
            ...
            <form action="after-registration.php" method="POST">
                <input class="reg-input" type="text" name="first-name" placeholder="First Name" required><br>
                <input class="reg-input" type="text" name="second-name" placeholder="Last Name" required><br>
